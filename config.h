...
enum State : int { exit_game, menu, gameplay, pause, highscore, playagain };
...
namespace config
{
    ...
    const int next_box_y = 50;                                      // Vertical distance from top left corner; in pixels

    const int hold_box_x = 475;                                     // Horizontal distance from top left corner; in pixels
    const int hold_box_y = 200;                                      // Vertical distance from top left corner; in pixels

    // Constants relating to Tetris
    const int wait_time_default = 1000;                                     // Time in milliseconds
    ...
    const SDL_Color another_text_color = { 0x00, 0x00, 0x00, 0xFF };
